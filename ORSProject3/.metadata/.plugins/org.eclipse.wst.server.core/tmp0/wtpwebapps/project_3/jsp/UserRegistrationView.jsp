				...
				<div class="col-md-4 mb-4">
					<div class="card input-group-addon grad">
						<div class="card-body">
							...
							<h3 class="text-center default-text text-light pb-2">User
								Registration</h3>
							<!--Body-->
							<div>
							...
							<span class="pl-sm-5"><b class="text-light">First
							...
							<span class="pl-sm-5"><b class="text-light">Last Name</b>
							...
							<span class="pl-sm-5"><b class="text-light">Password</b> <span
							...
							<span class="pl-sm-5"><b class="text-light">Confirm
									Password</b> <span style="color: red;">*</span></span> </br>
							<div class="col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
										<div class="input-group-text">
							...
							<span class="pl-sm-5"><b class="text-light">Email Id</b> <span
								style="color: red;">*</span></span> </br>
							<div class="col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
							...
							<span class="pl-sm-5"><b class="text-light">Mobile No</b>
								<span style="color: red;">*</span></span> </br>
							<div class="col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
							...
							<span class="pl-sm-5"><b class="text-light">Gender</b><span
								style="color: red;">*</span></span> </br>
							<div class="col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
							...
							<span class="pl-sm-5"><b class="text-light">DOB</b> <span
								style="color: red;">*</span></span></br>
							<div class="col-sm-12">
								<div class="input-group">
									<div class="input-group-prepend">
